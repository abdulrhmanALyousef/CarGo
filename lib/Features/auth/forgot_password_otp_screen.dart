...
import 'package:cargo/Features/auth/controllers/forgot_password_otp_controller.dart';
...
class ForgotPasswordOtpScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => ForgotPasswordOtpController(email: email),
      child: Builder(
        builder: (context) {
          final ctrl = context.watch<ForgotPasswordOtpController>();
