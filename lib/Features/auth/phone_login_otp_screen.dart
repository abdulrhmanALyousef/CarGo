...
import 'package:cargo/Features/auth/controllers/phone_login_otp_controller.dart';

class PhoneLoginOtpScreen extends StatelessWidget {
  final String phone; // full international format: +966XXXXXXXXX

  const PhoneLoginOtpScreen({super.key, required this.phone});
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => PhoneLoginOtpController(phone: phone),
      child: Builder(
        builder: (context) {
          final ctrl = context.watch<PhoneLoginOtpController>();
